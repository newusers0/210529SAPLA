...
public:
	...
	double& getPLAMBRSegmentDistance(const typename TOOL::INPUT_ARGUMENT& const input_argument, const T& MBR, const int& segment_id, const PLA& pla_array_qeury, Y& pla_MBR_segment_distance);
	...
	template<typename T, typename Y>
	double& getPLAMBRDistance(typename TOOL::INPUT_ARGUMENT& const input_argument, const T& MBR, const PLA& pla_array_qeury, Y& pla_MBR_distance);
...
TEMPLATE
template<typename T, typename Y>
double& PLA_QUAL::getPLAMBRSegmentDistance(const typename TOOL::INPUT_ARGUMENT& const input_argument, const T& MBR, const int& segment_id, const PLA& pla_array_qeury, Y& pla_MBR_segment_distance) {
...
TEMPLATE
template<typename T, typename Y>
double& PLA_QUAL::getPLAMBRDistance(typename TOOL::INPUT_ARGUMENT& const input_argument, const T& MBR, const PLA& pla_array_qeury, Y& pla_MBR_distance) {
...
long double PLA_QUAL::get_pla_sum_deviation(const T& const input_argument, const vector<Y>& const original_time_series, const T1& const pla, U& const result_collection) {
	...
	//cout << "PLA reconstruciton: ";
	//TOOL::print_vector(approximation);
	/*------------------------------------------*/
