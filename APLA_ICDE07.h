...
//#endif
	...
	/*=======================================================================================================*/
#ifdef _DEBUG
	assert(t == input_argument.point_dimension);
#endif
	t--;
...
void APLA_ICDE::getAPLA_ICDE07(typename TOOL::INPUT_ARGUMENT& const input_argument, const vector<DataType>& const original_time_series_vector, DoublyLinkedList<T>& const F_result_vector) {// From paper APLA ICDE 07 
	TOOL::recordStartTime(TOOL::time_record[49]);
#ifdef _DEBUG
	assert(input_argument.time_series_length != INF && input_argument.point_dimension != INF);
#endif
	...
	for (w = 1; w < input_argument.time_series_length; w++) {
		...
		//max_error_vector.emplace_back(std::vector<double>());
		/////////////////////////////////////////////////////////////////////////////////////////////////////////
		//if (w + 1 < input_argument.time_series_length && original_time_series_vector[w + 1] == original_time_series_vector[w]) {//Wrong, in paper, it means already get the set of APLA
			//max_error_vector[w - 1].emplace_back(INF);
			//max_error_vector[w][0] = -INF;
		//}
		//else {
...
//#ifdef _DEBUG
//	cout << "L a&b right_endpoint: \n";
//	for_each(L_PLA_factor_vector.apla.begin(), L_PLA_factor_vector.end(), [](auto&& const au) {
//		for (auto&& auu : au) {
//			cout << auu.right_endpoint << " "<< auu.rectangle_width <<" "<< auu.apla.apla.a <<" "<<auu.apla.apla.b<<",          ";
//		}
//		cout << endl;
//	});
//
//	cout << "Error : \n";
//	for_each(max_error_vector.apla.begin(), max_error_vector.end(), [](auto&& const au) {
//		for (auto&& auu : au) {
//			cout << auu << "        ";
//		}
//		cout << endl;
...
//#endif
	...
	//F_result_vector[1].rectangle_width = F_result_vector[1].right_endpoint + 1;
	/*=======================================================================================================*/
	/*delete temp_pla.apla.apla.a;
	delete temp_pla.apla.apla.b;
	delete last_pla.apla.apla.a;
	delete last_pla.apla.apla.b;*/
	...
	cout << "Best id : \n";
	for_each(A_best_right_endpoint_vector.apla.begin(), A_best_right_endpoint_vector.end(), [](auto&& const au) {
		for (auto&& auu : au) {
			cout << auu << " ";
		}
		cout << endl;
	...
	/*cout << endl;
	cout << "ICDE 07 a&b :  ";
	for_each(F_result_vector.apla.begin(), F_result_vector.end(), [](auto&& const au) {
		cout << au.apla.apla.a << " " << au.apla.apla.b << ", ";
	});
	cout << endl;*/

	//assert(c_max_error != INF && c_max_error != -INF && F_result_vector.size() == input_argument.point_dimension && F_result_vector.apla.back().right_endpoint == input_argument.time_series_length - 1 && F_result_vector.front().right_endpoint + 1 == F_result_vector.front().rectangle_width);
	//double sum_rectangle_width = F_result_vector.front().rectangle_width;

	//for_each(F_result_vector.apla.begin() + 1, F_result_vector.end(), [&](auto&& const au) {
	//	//cout << std::prev(&au, 1)->right_endpoint << " ";
	//	assert(au.right_endpoint != INF && au.rectangle_width == au.right_endpoint - std::prev(&au, 1)->right_endpoint);
	//	sum_rectangle_width += au.rectangle_width;
	//});
	//assert(sum_rectangle_width == input_argument.time_series_length);
#endif
	/*..........................................................................................................................*/

	/*-----------------------------------------Output Result-----------------------------------------------------*/
	//cout << "ICDE 07 right end point: ";
	//for_each(F_result_vector.apla.begin(), F_result_vector.end(), [](auto&& const au) {
	//	cout << au.right_endpoint + 1 << " ";
	//});
	//cout << endl;
	//cout << "ICDE 07 segment width: ";
	//for_each(F_result_vector.apla.begin(), F_result_vector.end(), [](auto&& const au) {
	//	//assert(au.right_endpoint != INF && au.rectangle_width == au.right_endpoint - std::prev(&au, 1)->right_endpoint);
	//	cout << au.rectangle_width << " ";
	//});
