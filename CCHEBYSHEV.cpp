#pragma once
#ifndef _CCHEBYSHEV_CPP_
#define _CCHEBYSHEV_CPP_
...
//
//	int point_id = 0;
//	double segment_len = input_argument.time_series_length / input_argument.point_dimension;
...
//void CHEBYSHEV_QUAL::rangeSearch(typename TOOL::INPUT_ARGUMENT& const input_argument, DataType*& const query_time_series, const CHEBYSHEV_SHARE& const  chebyshev_share, CHEBYSHEV*& const chebyshev_array, RTREE& const RTree, const double& const radius, priority_queue <ID_DIST, vector<ID_DIST>, priorityDecrement >& queue) {
...
////***************************************************************
//TEMPLATE
//std::multiset<pair<double, int>> CHEBYSHEV_QUAL::KNNCHEBYMulti(typename TOOL::INPUT_ARGUMENT& const input_argument, const typename TOOL::DATA_SOURCE& const data_source, DataType*& const query_time_series, const CHEBYSHEV_SHARE& const  chebyshev_share, CHEBYSHEV*& const chebyshev_array, RTREE& const RTree) {
//	assert(input_argument.time_series_length != INF && input_argument.time_series_length != INF && input_argument.K <= input_argument.point_number);
//#ifdef _DEBUG
//	input_argument.navigate_index_time = 0.0;// navigate time
//	input_argument.distance_lowbound_time = 0.0; // distance chebyshev, PLA, APCA time
